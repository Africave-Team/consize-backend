...
export const createSignature = async (signaturePayload: CreateSignatureInterface): Promise<SignatureInterface> => {
    const signature = new Signatures({ ...signaturePayload });
